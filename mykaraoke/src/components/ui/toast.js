...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (_jsx(ToastPrimitives.Viewport, { ref: ref, className: cn("fixed top-0 z-[100] flex h-fit max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-1/2 sm:translate-x-1/2 sm:top-0 sm:flex-col md:max-w-[420px]", className), ...props })));
